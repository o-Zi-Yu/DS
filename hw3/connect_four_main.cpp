...
void StudentTest(){
	Board b3("ABC","DEF","---");
	std::cout << "Initial board 3:" << std::endl << b3 << std::endl;
	b3.insert(0,true);
	b3.insert(0,true);
	b3.insert(10,false);
	b3.insert(0,true);
	std::cout << "Second handout figure" << std::endl << b3 << std::endl;
	std::cout << "Row 0 has " << b3.numTokensInRow(0) << std::endl;
	std::cout << "Row 8 has " << b3.numTokensInRow(8) << std::endl;
	std::cout << "Column 10 has " << b3.numTokensInColumn(10) << std::endl;
	Board b4("123","456","...");
	std::cout << "Initial board 4:" << std::endl << b4 << std::endl;
	b4.insert(1,true);
	std::cout << "Second handout figure" << std::endl << b4 << std::endl;
	b4 = b3;
	std::cout << "board 4 becomes board 3, draw b4:" << std::endl << b4 << std::endl;
}
