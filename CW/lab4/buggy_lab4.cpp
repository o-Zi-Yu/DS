...
// class my_cool_class {
// public:
//     my_cool_class(int a_number) {
//         (*this).a_number = a_number;
//     }
//     int a_number;
// }

// void my_func(my_cool_class & var) { 
//     var.a_number = 3;
// }

// my_cool_class obj;
// my_func(obj);
// print(obj.a_number)//xxx
...
int main() {
   ...
   const A::identifyMeanAndMin const(const x);
   return 0;
}

ta:zhenming
mentor:steph, alex, andrew
